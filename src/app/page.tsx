  ...
  return (
    <>
      ...
      <section className="hero"><div className="container hero-grid">
        ...
        <div className="hero-visual" aria-label="Sistem koji povezuje digital, ljude i realizaciju"><div className="hero-system"><div className="hero-orbit-stage"><div className="hero-glow" /><div className="hero-ring" /><div className="hero-ring" /><div className="hero-core"><strong>jedan brief<br />jedan sistem</strong></div></div><div className="hero-node-grid"><div className="hero-node hero-node-1"><strong>Digital</strong><span>Proizvod, kampanja i mjerenje</span></div><div className="hero-node hero-node-2"><strong>Ljudi</strong><span>Tim, priprema i odgovornost</span></div><div className="hero-node hero-node-3"><strong>Teren</strong><span>Lokacije, logistika i izvještaj</span></div></div></div></div>
      </div></section>
      ...
      <section className="section section-dark"><div className="container"><SectionHeading eyebrow="Radovi i sistemi" title="Projekti pokazuju kako različite discipline rade zajedno." text="Ne prikazujemo samo finalni vizual. Svaki case objašnjava problem, našu ulogu, postavljeni sistem, konkretan obim i ono što je projekat omogućio." /><div className="case-grid case-grid-home-scroll" role="region" aria-label="Istaknuti projekti" tabIndex={0}>{cases.slice(0, 3).map((item) => <CaseCard key={item.slug} item={item} />)}</div><div className="button-row" style={{ marginTop: 28 }}><Link className="button button-ghost" href="/radovi/">Pogledaj sve projekte</Link></div></div></section>
