...
export default function HomePage() {
  return (
    <>
      ...
      <section className="section section-dark"><div className="container"><SectionHeading eyebrow="Radovi i sistemi" title="Dokaz prije obećanja." text="Digitalni proizvodi, višemjesečni programi, promo operacije i događaji - svaki projekat prikazujemo kroz jasan problem, sistem i ishod." /><div className="case-grid">{cases.slice(0, 3).map((item) => <CaseCard key={item.slug} item={item} />)}</div><div className="button-row" style={{ marginTop: 28 }}><Link className="button button-ghost" href="/radovi/">Svi projekti</Link></div></div></section>
