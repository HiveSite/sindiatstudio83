...
const faqs = [
  ['Koliko košta saradnja?', 'Strategija i sprint kreću od 190 €, kontinuirani growth od 600 € mjesečno, dok se aktivacije i veći projekti procjenjuju prema obimu.'],
  ...
  return (
    <>
      ...
      <section className="section"><div className="container"><SectionHeading eyebrow="Problemi koje rješavamo" title="Marketing ne smije da bude skup odvojenih zadataka." text="Kampanja, sadržaj, sajt i teren moraju da podrže istu radnju. U suprotnom svako radi svoj dio, a rezultat nema vlasnika." /><div className="problem-grid">
        ...
        <article className="problem-card"><span>03</span><h3>Brend nema pouzdan tim za realizaciju</h3><p>Sourcing, raspored, briefing, leadovi smjene i kontrola nalaze se u jednom sistemu.</p></article>
        <article className="problem-card"><span>04</span><h3>Sezona ili launch dolaze bez pripremljenog funnel-a</h3><p>Spajamo ponudu, landing, distribuciju, sadržaj i lokalnu realizaciju prije nego što krene pritisak.</p></article>
      </div></div></section>
