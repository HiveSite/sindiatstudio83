...
const seoTitle = 'Kontakt - digitalni marketing, web, eventi i promo timovi'
const seoDescription = 'Pošaljite brief Sindikat Studio 83 timu iz Podgorice za digitalni marketing, web, aktivacije, događaje, sadržaj, promo timove ili recruitment kampanju u Crnoj Gori.'

export const metadata: Metadata = createMetadata({ title: seoTitle, description: seoDescription, path: '/kontakt/' })
...
export default function ContactPage() {
  ...
  return <>
    <JsonLd data={[
      ...
      webPageSchema({ name: seoTitle, description: seoDescription, path: '/kontakt/', type: 'ContactPage' }),
    ]} />
