...
export const metadata: Metadata = createMetadata({
  title: 'Industrije - turizam, retail, događaji i zapošljavanje',
  description: 'Digitalni sistemi, kampanje i terenska realizacija za ugostiteljstvo, turizam, retail, događaje, premium usluge i poslodavce u Crnoj Gori.',
  path: '/industrije/',
})
