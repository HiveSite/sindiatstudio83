...
export default function IndustriesPage() {
  ...
  return <>
    ...
    <section className="page-hero"><div className="container"><Breadcrumbs items={crumbs} /><div className="page-hero-grid"><div><span className="eyebrow">Industrije</span><h1>Fokus na tržišta gdje lokalna realizacija pravi razliku.</h1><p className="lead">Naša prednost nije samo digitalna distribucija. Vrijednost raste kada kampanju treba povezati sa lokacijom, sezonom, osobljem, događajem ili recruitment procesom.</p></div><aside className="page-hero-aside"><strong>Najčešći ciljevi</strong><ul><li>više rezervacija i posjeta</li><li>launch proizvoda ili lokacije</li><li>mjerljive aktivacije</li><li>više kvalitetnih kandidata</li></ul></aside></div></div></section>
