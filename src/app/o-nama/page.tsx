...
export default function AboutPage() {
  ...
  return <>
    ...
    <section className="section"><div className="container split-sticky"><div className="sticky-copy"><span className="eyebrow">Razvoj</span><h2>Od event industrije do integrisanog growth sistema.</h2><p className="lead">Počeli smo sa ljudima i događajima. Kroz rad smo vidjeli da teren bez kampanje ostaje izolovan, a kampanja bez sadržaja, landing flowa i operativnog kapaciteta brzo dođe do plafona.</p></div><div className="step-list">{[
      ['01','Event i promo operativa','Sourcing, roster, smjene, koordinacija i realizacija u Crnoj Gori.'],
