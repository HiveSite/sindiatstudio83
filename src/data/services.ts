...
export const services: Service[] = [
  {
    ...
    summary: 'Meta i Google kampanje povezujemo sa ponudom, landing stranicom, mjerenjem i kreativama. Fokus je na radnji koja vrijedi biznisu.',
    outcomes: ['više kvalitetnih upita', 'jasnija cijena konverzije', 'kontinuirano testiranje ponude i kreativa'],
    includes: [
      'analiza cilja, ponude i trenutnog prodajnog puta',
  ...
  },
  {
    ...
    summary: 'Pravimo brze, mobilno prioritetne stranice sa jasnom ponudom, strukturisanim sadržajem, SEO osnovom, analitikom i upotrebljivim formama.',
    outcomes: ['jasnija ponuda', 'manje trenja u formama', 'brži i mjerljiviji put do konverzije'],
    includes: [
      'informaciona arhitektura i korisnički tok',
      'tekst i struktura ponude',
  ...
  },
  {
    ...
    summary: 'Planiramo uvodne poruke, formate i varijante prema fazi prodajnog puta. Materijal se pravi za testiranje i distribuciju, a ne samo za uredan izgled profila.',
    outcomes: ['više kreativnih testova', 'jasnija poruka ponude', 'materijal prilagođen kanalima i fazama prodajnog puta'],
    includes: [
      'plan sadržaja i kreativa za oglase',
      'matrica uvodnih poruka, uglova i tekstova',
  ...
  },
  {
    ...
    summary: 'Povezujemo ponudu poslodavca, landing stranicu, oglase, zajednice i početna pitanja da kompanija dobije više relevantnih prijava, a ne samo veći broj CV-eva.',
    outcomes: ['više relevantnih kandidata', 'brža početna selekcija i organizovaniji proces', 'mjerljiva cijena prijave i izvora kandidata'],
    includes: [
      'definisanje ponude poslodavca i oglasa',
      'landing stranica i jednostavan tok prijave',
